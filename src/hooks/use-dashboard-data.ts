    ...
    const portfolioCompanies: PortfolioCompany[] = [
      {
        ...
        prediction: {
          ...
          confidence: 0.85,
          reasoning: 'Burn rate increased 15% last quarter while revenue growth slowed to 12%. Runway declining faster than projected. Recommend bridge funding discussion.',
        },
        anomalies: [
      ...
      },
      {
        ...
        prediction: {
          ...
          confidence: 0.79,
          reasoning: 'Clinical trial delays pushed revenue timeline back 6 months. Current cash reserves may be insufficient. High priority for bridge round or expense reduction.',
        },
        anomalies: [
      ...
      },
      {
        ...
        prediction: {
          ...
          confidence: 0.91,
          reasoning: 'Strong revenue growth (ARR +45% QoQ) and improving unit economics. Burn rate declining as company approaches profitability. Excellent trajectory.',
        },
      },
      {
        id: 'pc-4',
        ...
        prediction: {
          ...
          confidence: 0.88,
          reasoning: 'Consistent execution, strong product-market fit. Cash-efficient growth model with healthy margins. On track for Series B in 12-18 months.',
        },
      },
    ];
    ...
    const alerts: Alert[] = [
      {
        ...
        priority: 95,
        reasoning: 'Runway < 6 months is critical threshold. Company has high burn ($200K/mo) and recent clinical trial setbacks. Risk of down round or shutdown without intervention.',
        prediction: {
          label: 'Cash depletion date',
          value: new Date(today.getTime() + 180 * 24 * 60 * 60 * 1000).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }),
          confidence: 0.87,
        },
        action: {
      ...
      },
      {
        ...
        priority: 72,
        reasoning: 'Combination of increasing burn (+15%) and slowing revenue growth indicates operational challenges. Early warning sign requiring management attention.',
        prediction: {
      ...
      },
      {
        ...
        priority: 68,
        reasoning: 'Historical delay patterns for these LPs suggest 3-5 additional days needed. However, maintaining LP relationships requires proactive follow-up.',
        action: {
